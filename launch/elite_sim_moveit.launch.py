# Author: Chen Shichao
# Gazebo and MoveIt simulation launch file.
...
def launch_setup(context, *args, **kwargs):
    ...
    cs_control_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            [
                FindPackageShare("elite_robots_simulation_gz"),
                "/launch",
                "/elite_sim_control.launch.py",
            ]
        ),
        launch_arguments={
            "cs_type": cs_type,
...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            ...
            default_value="elite_robots_simulation_gz",
