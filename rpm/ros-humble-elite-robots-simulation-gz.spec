...
Name:           ros-humble-elite-robots-simulation-gz
Version:        1.0.1
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS elite_robots_simulation_gz package

License:        Apache-2.0
URL:            https://index.ros.org/p/elite_robots_simulation_gz/#humble
...
%description
Example and configuration files for Gazebo simulation of Elite Robots robot
manipulators.
...
%changelog
* Fri Sep 18 2026 chenshichao <chenshichao@elibot.cn> - 1.0.1-1
- Autogenerated by Bloom

* Wed Sep 02 2026 chenshichao <chenshichao@elibot.cn> - 1.0.0-1
- Autogenerated by Bloom
